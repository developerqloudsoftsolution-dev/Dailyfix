...
const Sample2 = () => {
  ...
  const handleAddToCart = (shadeName) => {
    ...
    toast.success(`${shadeName} added to Amber demonstration bag!`, {
      style: {
        background: '#121214',
        color: '#FFFFFF',
        borderRadius: '12px',
        ...
        fontWeight: '600',
        padding: '12px 18px',
        border: '1px solid rgba(162, 109, 52, 0.4)'
      },
      iconTheme: {
        primary: '#C79455',
        secondary: '#121214'
  ...
  return (
    <div className={styles.demoWrapper}>
        ...
        <div className={styles.headerInner}>
          <div className={styles.brandLogoWrap} onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            ...
            <div className={styles.brandTaglineCol}>
              ...
              <span className={styles.brandTaglineSmall}>Pure Men's Grooming</span>
            </div>
          </div>
          ...
          <div className={styles.headerActions}>
            ...
            >
              <ShoppingBag size={16} className="text-[#A26D34]" />
              <span>Demo Bag</span>
      ...
      {/* ========================================================
          SECTION 1: SPLIT EDITORIAL HERO (Amber & Obsidian)
      ========================================================= */}
        ...
        <div className={styles.heroContainer}>
          ...
          >
            <div className={styles.pillTag}>
              <Sparkles size={14} className="text-[#A26D34]" />
              <span>Logo Amber Palette • 100% Ammonia-Free</span>
            </div>

            <h1 className={styles.heroTitle}>
              Master Your Craft, <br />
              <span className={styles.heroTitleHighlight}>Defined in Gold.</span>
            </h1>

            <p className={styles.heroSubtitle}>
              Elevate your facial hair with a salon-grade botanical formulation in just 10 minutes. Infused with natural extracts to deliver undetectable gray coverage and conditioned luster.
            </p>
            ...
            <div className={styles.heroBulletsGrid}>
              ...
              <div className={styles.heroBulletCard}>
                ...
                <div>
                  ...
                  <p className={styles.heroBulletDesc}>Zero harsh chemical odor</p>
                </div>
              </div>
              ...
              <div className={styles.heroBulletCard}>
                ...
                <div>
                  <p className={styles.heroBulletTitle}>Botanical Oils</p>
                  <p className={styles.heroBulletDesc}>Nourishes beard hair</p>
                </div>
              </div>
            </div>
            ...
            <div className={styles.socialProofSnippet}>
              <div className={styles.avatarGroup}>
                ...
                <div className={styles.avatarCircle}>VK</div>
                <div className={styles.avatarCircle}>SR</div>
              </div>
              <div>
                <div className="flex items-center gap-1">
                  {[1, 2, 3, 4, 5].map((s) => (
                    <Star key={s} size={14} className="fill-[#A26D34] text-[#A26D34]" />
                  ))}
                  <span className="text-xs font-bold text-[#121214] ml-1">4.9 / 5.0</span>
                </div>
                <p className="text-xs text-[#5C564E] font-medium mt-0.5">
          ...
          >
            ...
            <div className={styles.floatingGlassBadge}>
              <span className="w-2 h-2 rounded-full bg-[#A26D34] animate-ping" />
              <span className="text-xs font-extrabold text-[#121214] uppercase tracking-wider">
            ...
            <div className={styles.floatingRatingBadge}>
              <Star size={14} className="fill-[#A26D34] text-[#A26D34]" />
              <span className="text-xs font-black text-[#121214]">4.9</span>
              <span className="text-[11px] text-[#5C564E]">({activeShade.reviews})</span>
            </div>
      ...
      {/* ========================================================
          SECTION 2: ASYMMETRIC BENTO GRID (Amber Edition)
      ========================================================= */}
      <section id="bento-features" className={styles.bentoSection}>
        <div className={styles.sectionHeaderCenter}>
          <div className={styles.pillTag}>
            <Award size={14} className="text-[#A26D34]" />
        ...
        <div className={styles.bentoGridContainer}>
          {/* Card 1: 10-Minute Rapid Gray Fusion (Span 7) */}
          <motion.div
          ...
          >
            <div>
              ...
              <p className={styles.bentoText}>
                No prolonged waiting. The specialized micro-pigment delivery penetrates the beard shaft in 10 minutes flat, delivering natural coverage that lasts weeks.
              </p>
            </div>
          ...
          >
            <div>
              ...
              <p className={styles.bentoText}>
                Infused with nourishing olive extract, argan oil, and taurine to soothe facial skin and eliminate itching or redness.
              </p>
            </div>

            <div className="mt-6 flex items-center gap-2 text-xs font-bold text-[#121214]">
              <CheckCircle2 size={16} className="text-[#A26D34]" />
              <span>Dermatologically tested for regular grooming</span>
            </div>
          </motion.div>

          {/* Card 3: Zero Skin-Stain Barrier (Span 5) */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <div>
              ...
              <p className={styles.bentoText}>
                The non-drip formulation locks onto facial hair keratin, keeping cheek lines and neckline completely clean without dark patches.
              </p>
            </div>

            <div className="mt-6 flex items-center gap-2 text-xs font-bold text-[#121214]">
              <CheckCircle2 size={16} className="text-[#A26D34]" />
              <span>Washes clean from skin with mild soap</span>
            </div>
          </motion.div>

          {/* Card 4: Consistent, Professional Results (Span 7) */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <div>
              ...
              <p className={styles.bentoText}>
                Calibrated specifically for Asian and Mediterranean hair tones, providing a natural multi-tonal reflection under bright sunlight.
              </p>
            </div>
      ...
      {/* ========================================================
          SECTION 3: 3-PRODUCT CURATED SHOWCASE & TRUST BAR
      ========================================================= */}
      <section id="product-collection" className={styles.productSection}>
        <div className={styles.sectionHeaderCenter}>
          <div className={styles.pillTag}>
            <ShoppingBag size={14} className="text-[#A26D34]" />
              ...
              <div>
                ...
                <div className={styles.productMetaWrap}>
                  <div className={styles.ratingRow}>
                    {[1, 2, 3, 4, 5].map((s) => (
                      <Star key={s} size={13} className="fill-[#A26D34] text-[#A26D34]" />
                    ))}
                    <span className="text-xs font-black text-[#121214] ml-1">{product.rating}</span>
                    <span className="text-[11px] text-[#5C564E]">({product.reviews})</span>
                  </div>
      ...
      <footer className={styles.footerContainer}>
        <div className={styles.footerInner}>
          ...
          <div>
            ...
            <ul className={styles.footerLinkList}>
              <li>
                <span className="text-xs text-[#5C564E] leading-relaxed block">
                  This static demonstration page is configured exclusively for client review under the Logo Colors (Amber Gold & Obsidian) theme.
                </span>
              </li>
              <li className="pt-2">
                <span className={styles.demoWatermark}>
                  <Check size={13} />
                  Sample 2 • Amber Edition
                </span>
              </li>
            </ul>
          </div>
